export function passwordResetEmail(verificationUrl: string) {
  return `<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="UTF-8" />
	...
	<body>
		<div class="container">
			...
			<div class="content">
				...
				<p>
					Follow the link below to change password
				</p>
				<a href="${verificationUrl}" class="button">Change Password</a>
			</div>
			<div class="footer">
				<p>
